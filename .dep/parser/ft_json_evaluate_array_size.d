.obj/parser/ft_json_evaluate_array_size.o: \
  src/parser/ft_json_evaluate_array_size.c inc/libftjson.h \
  ...
  /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/9.0.0/include/stdarg.h
	$(SILENT)printf 'o'
	$(SILENT)gcc   -Wall -Wextra -Werror -g  -Iinc  -I../libft/inc -c src/parser/ft_json_evaluate_array_size.c -o  .obj/parser/ft_json_evaluate_array_size.o
	$(SILENT)printf '\b✔'