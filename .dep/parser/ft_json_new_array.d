.obj/parser/ft_json_new_array.o: src/parser/ft_json_new_array.c \
  ...
  /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/9.0.0/include/stdarg.h
	$(SILENT)printf 'o'
	$(SILENT)gcc   -Wall -Wextra -Werror -g  -Iinc  -I../libft/inc -c src/parser/ft_json_new_array.c -o  .obj/parser/ft_json_new_array.o
	$(SILENT)printf '\b✔'